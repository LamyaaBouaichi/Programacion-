...
// Utilizar el método GET para obtener el socio con su respectivo ID
if (isset($_GET['id'])) {
    $id_socio = $_GET['id'];
...
// Utilizar el método POST para editar los datos de socio
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    //Si ha sido adcualiado el socio en la tabla, mediante el boton de guardar, nos manda al index
