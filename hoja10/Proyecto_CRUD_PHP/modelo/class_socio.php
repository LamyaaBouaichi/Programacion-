...
class Socio {
    ...
    // Agregar socios en el formulario
    ...
    // Función para obtener un socio cuyo ID es la que se necesita realizar la edición
    ...
    // Actualizar la tabla socios cuando el ID es la necesaria
    ...
    // Eliminar el socio mediante una consulta SQL
