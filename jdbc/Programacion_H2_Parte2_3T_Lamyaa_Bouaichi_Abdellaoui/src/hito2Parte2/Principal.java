		...
		// Hacemos uso de la librería
				...
				do {
					...
					switch (opciones) {
						...
						case 2:
							// Usamos la clase InsertarPelicula que ha sido creada para agregar nuevas películas
							InsertarPelicula add = new InsertarPelicula();
							add.añadirPelicula();
							System.out.println("\n");
						...
						case 3:
							// Usamos la clase ActualizarPelicula que ha sido creada para actualizar las películas que han sido agregadas anteriormente
							ActualizarPelicula actualizar = new ActualizarPelicula();
							actualizar.modificarPelicula();
							System.out.println("\n");
							
							break;
							
						case 4:
							// Usamos la clase EliminarPelicula que ha sido creada para eliminar las películas que han sido agregadas
